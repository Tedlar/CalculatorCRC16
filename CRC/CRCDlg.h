...
public:
	...
	CEdit m_editCycles;
private:
	const unsigned char aCRCHi[256] =
	{
	...
	const unsigned char aCRCLo[256] =
	{
...
private:
	bool checkEditBytes(CString);
	bool checkEditCycles(CString);
	void calculateCRC(CString _bytes, CString _cycles);
